...
if (isset($_GET['delete']) && is_numeric($_GET['delete'])) {
    try {
        ...
        if ($e->getCode() == '23000' && strpos($e->getMessage(), 'a foreign key constraint fails') !== false) {
            $errorMessage = "Impossible de supprimer cette catégorie car elle est utilisée dans une ou plusieurs recettes.\nVeuillez d’abord modifier ou supprimer les recettes qui utilisent cette catégorie.";
        } else {
